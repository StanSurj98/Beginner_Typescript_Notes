...
const someInputElement = document.querySelector('.bar');
// "<TypeAssertHere>Variable" also valid syntax for "as"
const someInputElement2 = document.querySelector('.baz');
...
someElement === null || someElement === void 0 ? void 0 : someElement.addEventListener('blur', (event) => {
